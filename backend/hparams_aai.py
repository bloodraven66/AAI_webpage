...
def parse_fastpitch_args(parent, add_help=False):
    ...
    symbols.add_argument('--symbols-embedding-dim', default=128, type=int,
                         help='Input embedding dimension')

    in_fft = parser.add_argument_group('input FFT parameters')
    in_fft.add_argument('--in-fft-n-layers', default=8, type=int,
                        help='Number of FFT blocks')
    in_fft.add_argument('--in-fft-n-heads', default=1, type=int, #1
                        help='Number of attention heads')
    in_fft.add_argument('--in-fft-d-head', default=8, type=int,
                        help='Dim of attention heads')
    in_fft.add_argument('--in-fft-conv1d-kernel-size', default=3, type=int,
                        help='Conv-1D kernel size')
    in_fft.add_argument('--in-fft-conv1d-filter-size', default=128, type=int,
                        help='Conv-1D filter size')
    in_fft.add_argument('--in-fft-output-size', default=128, type=int,
                        help='Output dim')
    ...
    out_fft.add_argument('--out-fft-n-layers', default=8, type=int,
                         help='Number of FFT blocks')
    out_fft.add_argument('--out-fft-n-heads', default=1, type=int, #1
                         help='Number of attention heads')
    out_fft.add_argument('--out-fft-d-head', default=8, type=int,
                         help='Dim of attention head')
    out_fft.add_argument('--out-fft-conv1d-kernel-size', default=3, type=int,
                         help='Conv-1D kernel size')
    out_fft.add_argument('--out-fft-conv1d-filter-size', default=128, type=int,
                         help='Conv-1D filter size')
    out_fft.add_argument('--out-fft-output-size', default=128, type=int,
                         help='Output dim')
    ...
    dur_pred.add_argument('--dur-predictor-filter-size', default=128, type=int,
